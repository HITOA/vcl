...
namespace VCL {
    ...
    public:
        ...
        std::optional<Error> Infer(std::vector<std::pair<std::string, TemplateArgument::TemplateValueType>>& templateParameters,
            std::vector<std::shared_ptr<TypeInfo>>& templatedArguments, std::vector<std::shared_ptr<TypeInfo>>& resolvedArguments);

        std::optional<Error> CheckParameters(std::vector<std::pair<std::string, TemplateArgument::TemplateValueType>>& templateParameters);
